...
var (
	...
	fd_EventCreate_creator protoreflect.FieldDescriptor
	fd_EventCreate_asset   protoreflect.FieldDescriptor
)

func init() {
	file_andromeda_test_v1alpha1_event_proto_init()
	md_EventCreate = File_andromeda_test_v1alpha1_event_proto.Messages().ByName("EventCreate")
	fd_EventCreate_creator = md_EventCreate.Fields().ByName("creator")
	fd_EventCreate_asset = md_EventCreate.Fields().ByName("asset")
}
...
func (x *EventCreate) slowProtoReflect() protoreflect.Message {
	mi := &file_andromeda_test_v1alpha1_event_proto_msgTypes[0]
...
func (x *fastReflection_EventCreate) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Creator != "" {
		...
		if !f(fd_EventCreate_creator, value) {
			return
		}
	}
	if x.Asset != "" {
		value := protoreflect.ValueOfString(x.Asset)
		if !f(fd_EventCreate_asset, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventCreate) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "andromeda.test.v1alpha1.EventCreate.creator":
		return x.Creator != ""
	case "andromeda.test.v1alpha1.EventCreate.asset":
		return x.Asset != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: andromeda.test.v1alpha1.EventCreate"))
		}
		panic(fmt.Errorf("message andromeda.test.v1alpha1.EventCreate does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventCreate) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message andromeda.test.v1alpha1.EventCreate does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventCreate) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "andromeda.test.v1alpha1.EventCreate.creator":
		panic(fmt.Errorf("field creator of message andromeda.test.v1alpha1.EventCreate is not mutable"))
	case "andromeda.test.v1alpha1.EventCreate.asset":
		panic(fmt.Errorf("field asset of message andromeda.test.v1alpha1.EventCreate is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: andromeda.test.v1alpha1.EventCreate"))
		}
...
func (x *fastReflection_EventCreate) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in andromeda.test.v1alpha1.EventCreate", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_EventSend_recipient protoreflect.FieldDescriptor
	fd_EventSend_asset     protoreflect.FieldDescriptor
)

func init() {
	file_andromeda_test_v1alpha1_event_proto_init()
	md_EventSend = File_andromeda_test_v1alpha1_event_proto.Messages().ByName("EventSend")
	fd_EventSend_sender = md_EventSend.Fields().ByName("sender")
	fd_EventSend_recipient = md_EventSend.Fields().ByName("recipient")
	fd_EventSend_asset = md_EventSend.Fields().ByName("asset")
}
...
func (x *EventSend) slowProtoReflect() protoreflect.Message {
	mi := &file_andromeda_test_v1alpha1_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_EventSend) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Recipient != "" {
		...
		if !f(fd_EventSend_recipient, value) {
			return
		}
	}
	if x.Asset != "" {
		value := protoreflect.ValueOfString(x.Asset)
		if !f(fd_EventSend_asset, value) {
			return
		}
	}
}
...
func (x *fastReflection_EventSend) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "andromeda.test.v1alpha1.EventSend.sender":
		return x.Sender != ""
	case "andromeda.test.v1alpha1.EventSend.recipient":
		return x.Recipient != ""
	case "andromeda.test.v1alpha1.EventSend.asset":
		return x.Asset != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: andromeda.test.v1alpha1.EventSend"))
		}
		panic(fmt.Errorf("message andromeda.test.v1alpha1.EventSend does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventSend) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message andromeda.test.v1alpha1.EventSend does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventSend) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "andromeda.test.v1alpha1.EventSend.sender":
		panic(fmt.Errorf("field sender of message andromeda.test.v1alpha1.EventSend is not mutable"))
	case "andromeda.test.v1alpha1.EventSend.recipient":
		panic(fmt.Errorf("field recipient of message andromeda.test.v1alpha1.EventSend is not mutable"))
	case "andromeda.test.v1alpha1.EventSend.asset":
		panic(fmt.Errorf("field asset of message andromeda.test.v1alpha1.EventSend is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: andromeda.test.v1alpha1.EventSend"))
		}
...
func (x *fastReflection_EventSend) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in andromeda.test.v1alpha1.EventSend", d.FullName()))
	}
	panic("unreachable")
}
...
func (*EventCreate) Descriptor() ([]byte, []int) {
	return file_andromeda_test_v1alpha1_event_proto_rawDescGZIP(), []int{0}
}
...
func (*EventSend) Descriptor() ([]byte, []int) {
	return file_andromeda_test_v1alpha1_event_proto_rawDescGZIP(), []int{1}
}
...
var file_andromeda_test_v1alpha1_event_proto_rawDesc = []byte{
	,
	...
	,
}

var (
	file_andromeda_test_v1alpha1_event_proto_rawDescOnce sync.Once
	file_andromeda_test_v1alpha1_event_proto_rawDescData = file_andromeda_test_v1alpha1_event_proto_rawDesc
)

func file_andromeda_test_v1alpha1_event_proto_rawDescGZIP() []byte {
	file_andromeda_test_v1alpha1_event_proto_rawDescOnce.Do(func() {
		file_andromeda_test_v1alpha1_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_andromeda_test_v1alpha1_event_proto_rawDescData)
	})
	return file_andromeda_test_v1alpha1_event_proto_rawDescData
}

var file_andromeda_test_v1alpha1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_andromeda_test_v1alpha1_event_proto_goTypes = []interface{}{
	(*EventCreate)(nil), // 0: andromeda.test.v1alpha1.EventCreate
	(*EventSend)(nil),   // 1: andromeda.test.v1alpha1.EventSend
}
var file_andromeda_test_v1alpha1_event_proto_depIdxs = []int32{
...
func init() { file_andromeda_test_v1alpha1_event_proto_init() }
func file_andromeda_test_v1alpha1_event_proto_init() {
	if File_andromeda_test_v1alpha1_event_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_andromeda_test_v1alpha1_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_andromeda_test_v1alpha1_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_andromeda_test_v1alpha1_event_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_andromeda_test_v1alpha1_event_proto_goTypes,
		DependencyIndexes: file_andromeda_test_v1alpha1_event_proto_depIdxs,
		MessageInfos:      file_andromeda_test_v1alpha1_event_proto_msgTypes,
	}.Build()
	File_andromeda_test_v1alpha1_event_proto = out.File
	file_andromeda_test_v1alpha1_event_proto_rawDesc = nil
	file_andromeda_test_v1alpha1_event_proto_goTypes = nil
	file_andromeda_test_v1alpha1_event_proto_depIdxs = nil
}
