...
var (
	...
	fd_EventSubmitProposal_id           protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EventSubmitProposal_id = md_EventSubmitProposal.Fields().ByName("id")
...
func (x *fastReflection_EventSubmitProposal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Id != uint64(0) {
		...
		if !f(fd_EventSubmitProposal_id, value) {
			return
		}
	}
	if x.Proposer != "" {
...
func (x *fastReflection_EventSubmitProposal) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "andromeda.escrow.v1alpha1.EventSubmitProposal.id":
...
func (x *fastReflection_EventSubmitProposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "andromeda.escrow.v1alpha1.EventSubmitProposal.post_actions":
		...
		return protoreflect.ValueOfList(value)
	case "andromeda.escrow.v1alpha1.EventSubmitProposal.id":
		panic(fmt.Errorf("field id of message andromeda.escrow.v1alpha1.EventSubmitProposal is not mutable"))
	case "andromeda.escrow.v1alpha1.EventSubmitProposal.proposer":
...
func (x *EventSubmitProposal) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_andromeda_escrow_v1alpha1_event_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x6e, 0x67, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x97, 0x02,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x8d, 0x01, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x45, 0x78, 0x65, 0x63, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61,
	0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61,
	0x6c, 0x12, 0x34, 0x0a, 0x08, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x18, 0xd2, 0xb4, 0x2d, 0x14, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x52, 0x08, 0x65,
	0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x12, 0x2e, 0x0a, 0x07, 0x61, 0x63, 0x74, 0x69, 0x6f,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0xdf, 0x01, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e,
	0x61, 0x6e, 0x64, 0x72, 0x6f, 0x6d, 0x65, 0x64, 0x61, 0x2e, 0x65, 0x73, 0x63, 0x72, 0x6f, 0x77,
	0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74,
